...
const onSaleItems = [
   ...
   },
   {
      id: 4,
      image: "/speaker.jpg",
      title: "Turn5 Portable Bluetooth Speaker",
      oldPrice: "$85.00",
      newPrice: "$70.00",
   },
   {
      ...
      <section className={styles.heroSection}>
         ...
         <div className={styles.cardsContainer}>
            ...
            <div className={styles.card} style={{ backgroundColor: "#673AB7" }}>
               ...
               <img
                  src="/headphone-promo.jpg"
                  alt="Headphone Promotion"
                  className={styles.cardImage}
               />
            </div>
         </div>
         ...
         <div className={styles.bestSellersSection}>
            ...
            <button
               ...
               onClick={() => router.push("/shop")} // Navigate to /shop on click
            >
               View All
            </button>
         </div>
         ...
         <div className={styles.promoBanner}>
            ...
            <div className={styles.promoContent}>
               ...
               <button className={styles.shopButton} onClick={() => router.push("/shop")}>Shop Now</button>
            </div>
         </div>
         {/* On Sale Section */}
         <div className={styles.onSaleSection}>
            ...
            <button className={styles.viewAllButton} onClick={() => router.push("/shop")}>View All</button>
         </div>
         ...
         <div className={styles.promoBanner1}>
            ...
            <div className={styles.promoContent1}>
               ...
               <h3>
                  <span className={styles.discount1}>30%</span> OFF
               </h3>
               <p>On professional camera drones</p>
               <p className={styles.smallText1}>
            ...
            <div className={styles.promoImageContainer1}>
               <img
                  src="/promo-banner2.jpg"
                  alt="Promotional Offer"
                  className={styles.promoImage1}
               />
